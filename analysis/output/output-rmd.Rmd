---
title: "Information loss due to categorising variability in epidemic model comparisons"
...
target_labels <- c("ES inc case", "BE inc case", "NL inc case", "BE inc death", "NL inc death")
...
```{r create-ensembles, fig.caption=ensemble_caption, fig.height=8, fig.width=12}
...
```{r samples-weights, fig.caption=weights_caption, fig.width = 12}
# Score samples
